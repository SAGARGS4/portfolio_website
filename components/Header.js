	...
	return (
		<header className="mb-12">
			...
			<div className="flex flex-row items-center justify-between gap-4 mb-4">
				{/* Left: Animated Name */}
				<h1 className="text-2xl sm:text-3xl md:text-5xl font-bold flex flex-wrap gap-[6px]">
					Hi, I&apos;m{" "}
					{nameLetters.map((char, index) => (
						<motion.span
							key={index}
				...
				<motion.div
					...
					animate={{ opacity: 1, scale: 1 }}
					transition={{ duration: 0.5, delay: 1 }}
					className="w-20 h-20 sm:w-28 sm:h-28 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-gray-300 shadow-lg flex-shrink-0"
				>
					<img
						src="/profile.png"
						alt="Profile"
